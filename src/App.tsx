...
function App() {
  ...
  const handleRequestOffer = (product: Product) => {
    ...
    window.open(`https://wa.me/+254762801974?text=${encodeURIComponent(message)}`);
  };
  ...
  const handleRequestOrder = () => {
    ...
    window.open(`https://wa.me/+254762801974?text=${encodeURIComponent(fullMessage)}`);
  };
  ...
  return (
    <div className="min-h-screen bg-gray-50">
      ...
      <main className="max-w-7xl mx-auto px-4 py-6 md:py-8">
        ...
        <a
          href="https://wa.me/254762801974?text=I%20would%20like%20to%20inquire%20about%20your%20products"
          target="_blank"
        ...
        <div className="max-w-7xl mx-auto px-4">
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            ...
            <div>
              ...
              <p className="text-gray-400 mb-2">Phone: +254762801974</p>
