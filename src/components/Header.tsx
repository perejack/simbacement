      ...
      <div className="bg-blue-700 text-white py-2 px-4 text-sm hidden md:block">
        <div className="max-w-7xl mx-auto flex justify-between items-center">
          <div className="flex items-center space-x-4">
            <a href="tel:+254762801974" className="flex items-center hover:text-blue-200 transition-colors">
              <Phone className="w-4 h-4 mr-1" /> +254762801974
            </a>
      ...
      {mobileMenuOpen && (
        <div className="md:hidden bg-white border-t border-gray-200 py-3 px-4 shadow-lg">
          ...
          <nav className="space-y-3">
            ...
            <div className="py-2">
              <a href="tel:+254762801974" className="flex items-center text-blue-600 font-medium">
